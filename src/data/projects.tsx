...
import conviteLivo from "@/assets/projects/convite-livo.mp4"
...
export const projects: Project[] = [
    {
        ...
        description:
            <p>
                Esse foi o primeiro projeto, entre os que estavam em produção no meu último emprego, que precisei atualizar.
                Além de adaptar a estética ao novo site da empresa, também implementei melhorias significativas, como:
                <ul className="list-disc pl-3 pt-2">
                    <li>Validações mais robustas;</li>
                    <li>Um novo formato de formulário, agora dividido em múltiplas etapas (multi-step);</li>
                    <li>E ajustes gerais na experiência do usuário para torná-la mais fluida e intuitiva.</li>
                </ul>
            </p>,
        midia: conviteLivo,
        stack: ['React', 'TypeScript', 'Tailwind', 'Node', 'Zod', 'Shadcn-ui'],
