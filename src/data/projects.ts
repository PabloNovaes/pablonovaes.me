...
export const projects: Record<string, ProjectsProps> = {
    ...
    'ts-table': {
        name: 'Ts-Table',
        description: 'Este foi o primeiro projeto em React que desenvolvi sozinho sem auxilio de curso ou coisa do tipo,e por mais simples que seja, tive um aprendizado significativo em react e ts. É uma tabela com dadoa estáticos, podendo ser feita a inclusao de um novo produto e aplicação de filtros.',
    ...
    'ts-form': {
        name: 'Ts-Form',
        description: 'Um formulario em react com ts, onde pude praticar ainda mais o uso do Zod para lidar com o formulario (desde sua configuração no projeto, até o seu uso em si), não possui muitas validações devido a simplicidade do projeto.',
